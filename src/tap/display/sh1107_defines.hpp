...
#ifndef TAPROOT_SH1107_DEFINES_HPP_
#define TAPROOT_SH1107_DEFINES_HPP_
...
#define SH1107_COL_ADDRESS_MSB 0x10
// (2) Set Higher Column Address
#define SH1107_COL_ADDRESS_LSB 0x00

// (3) Set Pump voltage value (unused)
// (4) Set Display Start Line (unused)

// (5) Set Contrast Control Register
#define SH1107_CONTRAST_MODE 0x81
#define SH1107_CONTRAST_DATA 0x00

// (6) Set Segment Re-map
#define SH1107_ADC_NORMAL 0xA0
#define SH1107_ADC_REVERSE 0xA1

// (7) Set Entire Display OFF/ON
#define SH1107_FORCE_ON_DEFAULT 0xA4
#define SH1107_FORCE_ON_ENABLED 0xA5

// (8) Set Normal/Reverse Display
#define SH1107_NORMAL 0xA6
#define SH1107_REVERSE 0xA7

// (9) Set Multiplex Ration (unused)
// (10) Set DC-DC OFF/ON (unused)

// (11) Display OFF/ON
#define SH1107_ON 0xAF
#define SH1107_OFF 0xAE

// (12) Set Page Address
#define SH1107_PAGE_ADDRESS 0xB0

// (13) Set Common Output Scan Direction
#define SH1107_SCAN_DIR_NORMAL 0xC0
#define SH1107_SCAN_DIR_REVERSE 0xC8
...
#endif  // TAPROOT_SH1107_DEFINES_HPP_
