...
public:
     ...
     */
    StaticTransform(const Position& translation, const Orientation& rotation);
    StaticTransform(Position&& translation, Orientation&& rotation);

    /**
     * @param rotation Initial rotation of this transformation.
     * @param position Initial translation of this transformation.
     */
    StaticTransform(const CMSISMat<3, 1>& translation, const CMSISMat<3, 3>& rotation);
    StaticTransform(CMSISMat<3, 1>&& translation, CMSISMat<3, 3>&& rotation);
     ...
     */
    StaticTransform(float x, float y, float z, float roll, float pitch, float yaw);

    // TODO: template specialization for transform between identical frames??
    /**
     * Constructs an identity transform.
     */
    static inline StaticTransform identity() { return StaticTransform(0., 0., 0., 0., 0., 0.); }
