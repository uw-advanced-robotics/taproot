...
TEST(MoveUnjamComprisedCommand, command_registers_subsystem_requirements)
{
    ...
    MoveUnjamComprisedCommand command(&drivers, &subsystem, 5.0f, 3.0f, 2.5f, 1000, 30, true, 0.2f);
...
{
    CREATE_COMMON_TEST_OBJECTS();
    MoveUnjamComprisedCommand command(&drivers, &subsystem, 7.5f, 3.0f, 2.5f, 1000, 15, true, 0.2f);
